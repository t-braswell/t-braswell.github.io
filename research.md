...
I am also doing thesis research with [Dr. Christopher Curtis](https://cwcurtis.github.io/) on machine learning and link prediction on bipartite graphs. this is an extension of Maryam Sabagh's [Master's thesis on the subject](https://sciety.org/articles/activity/10.32388/074o28 ), looking for ways to better capture local graph structure for graph neural networks.

Past research and projects for classes include work on [Convergence speeds of optimization algorithms](/downloads/693a_final_paper.pdf) and [Polynomial division from a Fourier Perspective](/downloads/668_presentation.pdf ).
