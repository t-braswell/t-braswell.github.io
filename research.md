...
I am currently a member of the [Sethuraman Lab](https://www.sethuramanlab.com/){:target="_blank"}  at SDSU, working under [Arun Sethuraman](https://biology.sdsu.edu/people/arun-sethuraman/){:target="_blank"}  on computational biology and bioinformatics. Currently, I am attempting to refine the methods established by Tamsen Dunn's [specKS](https://github.com/tamsen/specks){:target="_blank"}  simulator for polyploid evolution, by using Gaussian Mixture models rather than naive RMS error reduction for comparing simulation results with empirical data.
